...
class RunCurve(RunCurveTerrain):
    """
    Extend the multi terrain experiment by introducing curve run specific rewards
    """
    def _reward_progress(self):
        """Rewards prgress when running in the direction the robot is heading"""
    ...
    def _reward_lateral_drift(self):
        """Penalizes sideway lateral movement but only if no angular velocity command is given"""
