...
def get_cfgs():
	...
	"reward_scales": {
            ...
            "tracking_ang_vel": 0.5, # erhöht von 0.2: stärkerer Druck gegen Yaw-Rate bei ang_vel_range=[0,0]
            ...
            "heading": -10.0, # NEU: bestraft Yaw-Abweichung direkt (ersetzt sideway_movement, das bei hohem Tempo sättigte)
        },
    }
    command_cfg = {
        "num_commands": 3,
