...
gs.init(backend=gs.gpu, precision="64", logging_level="warning") # set precision to 64 for more stable physics simulation, logging level to error to avoid warnings about small penetrations that we get with the terrain
