...
class SprintFlatTerrain(Go2Env):
    ...
    def _reward_paper_lateral_drift(self):
        """Bestraft das seitliche Abweichen von der ursprünglichen Spur."""
        # Alt: self.base_init_pos[1] -> Greift auf den X,Y,Z Vektor des 2. Roboters zu
        # Neu: self.base_init_pos[:, 1] -> Greift auf die Y-Koordinaten ALLER 1024 Roboter zu
