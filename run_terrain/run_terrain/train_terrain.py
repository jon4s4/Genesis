...
gs.init(backend=gs.gpu, precision="32", logging_level="warning") # set precision to 64 for more stable physics simulation, logging level to error to avoid warnings about small penetrations that we get with the terrain
...
def get_cfgs():
    ...
    command_cfg = {
        ...
        "lin_vel_x_range": [0.3, 3.0],      # min/max Vorwärtsgeschwindigkeit (m/s)
