...
def get_cfgs():
    env_cfg = {
        ...
        "action_scale": 1.0, # this is smth like the amplitude knob that converts the policy's dimesionless output into real angles
    ...
    reward_cfg = {
        "tracking_sigma": 0.25,  # kleiner = strengeres Tracking
        "reward_scales": {
    ...
    command_cfg = {
        ...
        "lin_vel_x_range": [0.3, 1.5],      # min/max Vorwärtsgeschwindigkeit (m/s)
