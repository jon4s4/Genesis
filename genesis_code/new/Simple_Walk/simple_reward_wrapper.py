...
class WalkRandomTerrain(Go2Env):
    """
    Reward wrapper for fast forward locomotion with curriculum learning.
    All rewards in reward_cfg["reward_scales"] must have a corresponding
    _reward_<name> method either here or in Go2Env.

    Rewards defined here override the base-class versions.
    Rewards already handled by Go2Env (and therefore NOT redefined here):
